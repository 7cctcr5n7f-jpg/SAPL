...
export const fixtures = pgTable(
  "ppl_fixtures",
  {
    ...
    homePoints: doublePrecision("homePoints"),
    awayPoints: doublePrecision("awayPoints"),
...
export const results = pgTable(
  "ppl_results",
  {
    ...
    homePoints: doublePrecision("homePoints").notNull().default(0),
    awayPoints: doublePrecision("awayPoints").notNull().default(0),
    homeSetsWon: integer("homeSetsWon").notNull().default(0),
    awaySetsWon: integer("awaySetsWon").notNull().default(0),
    winnerTeamId: integer("winnerTeamId"),
...
export const standings = pgTable(
  "ppl_standings",
  {
    ...
    matchesWon: integer("matchesWon").notNull().default(0),
